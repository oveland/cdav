...
<head>
    ...
    <meta content="{{ config('app.name', 'CDAV Gestión de Patios') }}" name="description"/>
    <!-- CSRF Token -->
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="{{ url('/')  }}" class="m-t-5 m-r-5 text-center animated">
                <span class="text-white f-s-16">CDAV</span><span class="text-danger f-s-22">PATIOS</span>
            </a>
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <a href="{{ url('beta/inventories') }}">@lang('Home')</a>
...
<div class="page-footer">
    <div class="page-footer-inner"> 2017 &copy; PCW Ditech Integradores Tecnológicos:
